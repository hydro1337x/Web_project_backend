...
class UpdatePasswordValidator {
  ...
  async handle ( ctx, next) {
    ...
    const messages = {
      ...
      'repeatedOldPassword.min': 'Your repeated password must be at least 6 characters long',
    ...
    if (input.oldPassword != input.repeatedOldPassword) {
      return response.badRequest(new ResponseData(false, 'Your old password and repeated password do not match', null, null))
    }
